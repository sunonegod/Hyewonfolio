...
$(document).ready(function(){
    $('.cloup').mouseover(function(){
        $('.cloup_thumb').addClass('active')
    })
});

$(document).ready(function(){
    $('.cloup').mouseout(function(){
        $('.cloup_thumb').removeClass('active')
    })
});

$(document).ready(function(){
    $('.lizzie').mouseover(function(){
        $('.lizzie_thumb').addClass('active')
    })
});

$(document).ready(function(){
    $('.lizzie').mouseout(function(){
        $('.lizzie_thumb').removeClass('active')
    })
});

$(document).ready(function(){
    $('.vegan').mouseover(function(){
        $('.vegan_thumb').addClass('active')
    })
});

$(document).ready(function(){
    $('.vegan').mouseout(function(){
        $('.vegan_thumb').removeClass('active')
    })
});
